...
class MenuCategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create menu_category" do
    assert_difference('MenuCategory.count') do
      post menu_categories_url, params: { menu_category: { category_id: @menu_category.category_id, menu_id: @menu_category.menu_id } }
    end
  ...
  test "should update menu_category" do
    patch menu_category_url(@menu_category), params: { menu_category: { category_id: @menu_category.category_id, menu_id: @menu_category.menu_id } }
